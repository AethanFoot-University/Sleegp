...
\begin{reqsection}{viewing-collecting-data}
...
\begin{reqsection}{identifying-trends-data}
  \req{compare-sleep-data}
  \req{Automation-of-data}
\end{reqsection}

\begin{reqsection}{goals-achievements}
...
\begin{reqsection}{manage-data-periodically}
  \req{delete-data}
\end{reqsection}
