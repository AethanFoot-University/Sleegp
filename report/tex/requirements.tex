...
\begin{reqtable}
  ...
  \source{Sleep Application questionnaire and Meeting minutes \#24}
...
\subrequirement{sreq:allow-GUIuser-record-data}
  {The Graphical User Interface should allow the user to record data from the headset and choose where
    to store it.}
  \phigh
  \deps{\ref{sreq:read-data-headset}, \ref{sreq:facilitate-saving}}
  \smin{24}

  \subrequirement{sreq:specifystart-time-record}
  {The Graphical User Interface should allow the user to start recording their sleep cycle data.}
  \phigh
  \deps{\ref{sreq:allow-user-record-data}}
  \smin{24}

  \subrequirement{sreq:specifystop-time-record}
  {The Graphical User Interface should allow the user to stop recording their sleep cycle data.}
  \phigh
  \deps{\ref{sreq:allow-user-record-data}}
  \smin{24}
  ...
  {The Graphical User Interface must allow the user to process sleep cycle data from a raw recorded
    data file.}
  \phigh
  \dnone
  \smin{24}
  ...
  {The Graphical User Interface must allow the user to view the selected processed sleep cycle data in the form of a line graph.}
  \phigh
  \deps{\ref{sreq:present-hypnogram}}
  \source{Sleep app questionnaire and Meeting Minutes \#24}


    \subrequirement{sreq:GUI-ManageGoal}
    {The Graphical User Interface must allow the user to set, change and manage a goal for the average time they want to sleep during the week.}
    \phigh
    \deps{\ref{req:allow-manage-goals}}
    \source{Sleep app questionnaire and Coursework Specification}
