	...
	public void run() {
		if(running && neuroSocket.isConnected()){
			...
			try {
				while ((userInput = stdIn.readLine()) != null) {
                                        if(userInput.contains("eSense"))System.out.println("IN:"+userInput);
	      ...
	      try {
	       /* poorSignalEventMethod.invoke(parent, new Object[] {
	          poorSignalLevel
                  ...
                  System.out.println("Poor level: "+poorSignalLevel);
	        //println("Attention: " + attention);
	      } 
	      catch (Exception e) {
	        System.err.println("Disabling meditationEvent()  because of an error.");
	      ...
	      try {
	        /*blinkEventMethod.invoke(parent, new Object[] {
	          blinkStrength
                  ...
                  System.out.println("Blink: "+blinkStrength);
	      } 
	      catch (Exception e) {
	  ...
	  private void parsePacket(JSONObject data){
          ...
          public static void main(String[] main) throws IOException{
              ThinkGearSocket sock = new ThinkGearSocket();
              
            try {
               sock.start();
            } catch (ConnectException ex) {
                Logger.getLogger(ThinkGearSocket.class.getName()).log(Level.SEVERE, null, ex);
            }
          }
}